...
================================================================================
  ...
  - Semantic Views: STOCK_PRICE_TIMESERIES_SV, AIM_STOCK_PRICES_SV, SP500, EDGAR_FILINGS_SV
  - Tables: SP500_COMPANIES, STOCK_PRICE_TIMESERIES, AIM_STOCK_PRICES, EDGAR_FILINGS, PUBLIC_TRANSCRIPTS, DOCS_CHUNKS_TABLE
  - Functions: PDF_TEXT_CHUNKER
  - Stages: COMPANY_ANNOUNCEMENTS
  - Yahoo Finance: Network rule, external access integration, UDF
  - Tasks: DAILY_DATA_REFRESH
  - Database: COLM_DB
...
-- ============================================================================
-- STEP 5: DROP FUNCTIONS AND STAGES
-- ============================================================================
...
-- ============================================================================
-- STEP 5.2: DROP YAHOO FINANCE OBJECTS
-- ============================================================================
...
-- ============================================================================
-- STEP 5.4: DROP MCP ROLE AND OAUTH INTEGRATION
-- ============================================================================
