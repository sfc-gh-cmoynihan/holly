...
================================================================================
  ...
  3. SCHEMA NOTE: The default schema is PUBLIC_DATA. Non-trial accounts may use CYBERSYN instead.
     If you are on a non-trial account, find-and-replace 'PUBLIC_DATA' with 'CYBERSYN' before running.
...
SELECT * FROM VALUES
    ...
    ('CPB', 'Campbell''s Company (The)', 'Consumer Staples', 'Packaged Foods & Meats', 'Camden, New Jersey', '1957-03-04', '16732', '1869'),
...
-- The agent spec below is identical to HOLLY.sql.
...
UNION ALL SELECT 'DOCS_CHUNKS_TABLE', COUNT(*) FROM COLM_DB.UNSTRUCTURED.DOCS_CHUNKS_TABLE;
...
--   AIM_STOCK_PRICES: ~2,300 daily records (loaded separately via scripts/load_aim_stock_prices.py)
--   EDGAR_FILINGS: varies based on filings
--   PUBLIC_TRANSCRIPTS: varies based on available transcripts
--   DOCS_CHUNKS_TABLE: ~106 chunks (loaded separately via PDF upload + Cortex PARSE_DOCUMENT)
--
